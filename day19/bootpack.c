...
void HariMain(void)
{
    ...
    int mx, my, i, cursor_x, cursor_c, key_to=0, key_shift=0, key_leds=(binfo->leds>>4)&7, keycmd_wait=-1;
    ...
    io_out8(PIC0_IMR, 0xf8); // allow PIT and PIC1
...
{    
    ...
    boxfill8(buf, xsize, COL8_FFFFFF, 1, 1, 1, ysize-1);
...
void console_task(struct SHEET *sheet, unsigned int memtotal)
{
    ...
    int i, fifobuf[128], cursor_x=16, cursor_y=28,cursor_c=COL8_000000;
    int x, y;
            ...
            if (256 <= i && i <= 511)
            {
                ...
                else
                {
                    ...
                    if (cursor_x < 240)
                    {
                        ...
                        putfonts8_asc_sht(sheet, cursor_x, cursor_y, COL8_FFFFFF, COL8_000000, s, 2);
                        cursor_x += 8;
                    }
                }
            }
